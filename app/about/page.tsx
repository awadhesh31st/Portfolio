          ...
          <div className="flex flex-col items-center justify-center gap-20 sm:gap-32">
            <div className="flex flex-col items-center justify-center gap-5 text-sm font-thin sm:font-extraLight mt-14 text-biege sm:text-lg">
              <p>
                ...
                with a passion for Javascript and a strong expertise in ReactJS.
                I have a great depth of knowledge in developing performant,
                decoupled, testable and maintainable code that is easy to work
                with. I enjoy working collaboratively with my teammates, sharing
                my knowledge and skills, and learning new technologies in the
                process.
              </p>
              <p>
                ...
                and leverage existing libraries whenever it makes sense. I have
                the ability to
              ...
              <p>
                ...
                is what drives me to constantly improve and challenge myself. I
                believe in the power of design and user experience to drive
                success and satisfaction for both businesses and their
                customers.
              </p>
            </div>
            <div className="flex flex-col items-center justify-center">
              <Image src={checkAll} alt="check-all" className="w-56 h-auto" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container grid grid-cols-1 gap-10 lg:gap-0 p-11 md:p-16 lg:grid-cols-2 lg:gap-x-8">
          <div className="flex flex-col items-start justify-start gap-6 text-xl text-coal sm:gap-10">
            ...
            <h4 className="text3xl sm:text-4xl font-semiBold">
              best practices into my work to make sure that all users can access
              and use the interfaces I create
            </h4>
